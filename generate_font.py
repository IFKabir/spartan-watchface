...
for c in chars:
    ...
    # Render char isolated to get true bounds
    ...
    if c_bbox:
        ...
        # Garmin bmfont parser needs these values
        ...
        fnt_content.append(f'char id={ord(c)} x=0 y=0 width=0 height=0 xoffset=0 yoffset=0 xadvance={info["advance"]} page=0 chnl=15')
